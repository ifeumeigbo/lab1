...
**2** Can you think of 3 hypotheses for why someone may be more likely to miss a medical appointment? People could miss medical appointments for several reasons. It could be because of the weather conditions on the day of an appointment. It could be because they may not be satisfied with the doctor or healthcare professional that was assigned to them. It could also be because the initial symptoms, that prompted them to schedule an appointment, have subsided and they deem the appointment as unnecessary.
