...
From the plot, it looks like people who do not receive SMS are more likely to not show up for an appointment, although this is not a significance difference, therefore from the plot receiving SMS reminders may slightly decrease the chance of not attending an appointment. However, the data is not well balanced, as there are about twice as many people who did not receive SMS than there are people who received SMS.
...
neighbourhoods.  
Distance to the appointment hospital could be a reason why a certain neighbourhood has a higher or lower rate compared to other neighbourhoods. People may be more likely to not show up for an appointment if the commute distance is longer.
...
odd?  
From the plot, same-day appointments have a very high attendance rate. However, it is not clear whether this is a data collection error or if it is indeed possible to book an appointment for the same day on a given day. Most of the appointments that patients actually showed up to attend seem to have been scheduled on the same day which could represent a bias or it could be from a data collection error.
