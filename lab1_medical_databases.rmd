...
in this plot?  
Yes I see an issue with including PatientID/AppointmentID in the correlation plot because they are not providing any actionable information here.
...
If you only plotted just the amount of no shows alone, you would not get the full context with regards to other age groups. But by plotting the proportion, you can see how no shows are distributed across the different age groups.
