...
I think it might work a little bit well, but considering that the data may have some issues (such as the irregularity in the lag) and the imbalance in the data, the result or efficiency in the model could be affected.
